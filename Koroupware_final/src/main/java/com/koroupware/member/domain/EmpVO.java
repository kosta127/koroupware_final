...
public class EmpVO implements Serializable{
	...
	public String toString() {
		return "EmpVO [emp_no=" + emp_no + ", emp_name=" + emp_name + ", dept_no=" + dept_no + ", emp_email="
				+ emp_email + ", emp_superior=" + emp_superior + ", emp_reporter=" + emp_reporter + ", emp_id=" + emp_id
				...
				+ ", emp_img=" + emp_img + ", emp_elec_auth_img=" + emp_elec_auth_img + ", emp_point=" + emp_point
				+ "]";
	}
